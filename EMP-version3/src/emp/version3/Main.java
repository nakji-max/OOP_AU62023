...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        Date birthDate = dateFormat.parse("15-05-2003");
         ...
         Name empName = new Name("James","Cheong","B","SR","Jobeless");
         
        
        //HOURLY EMPLOYEE
        HourlyEmployee Houremployee = new HourlyEmployee(1, empName, hireDate, birthDate, 8, 50);
//        employee.printEmployeeDetails();
        ...
        PieceWorkerEmployee PieceEmployee = new PieceWorkerEmployee(1, empName, pieceWorkerHireDate, pieceWorkerBirthDate, 100, 5.0f);
//        PieceEmployee.printPieceWorkerDetails();
        ...
        CommissionEmployee CommissionEmployee = new CommissionEmployee(1, empName, CommissionHireDate, CommissionBirthDate, 75000.0);
//        CommissionEmployee.printCommissionEmployeeDetails();
        ...
        BasePlusCommissionEmployee BaseCommissionEmployee = new BasePlusCommissionEmployee(1, empName, BaseCommissionHireDate, BaseCommissionBirthDate, 75000.0, 20000.0);
